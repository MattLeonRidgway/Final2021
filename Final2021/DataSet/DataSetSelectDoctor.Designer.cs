...
namespace Final2021.DataSet {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("DataSetSelectDoctor")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class DataSetSelectDoctor : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected DataSetSelectDoctor(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            DataSetSelectDoctor cln = ((DataSetSelectDoctor)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "DataSetSelectDoctor";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/DataSetSelectDoctor.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            DataSetSelectDoctor ds = new DataSetSelectDoctor();
        ...
        public partial class DoctorDataTable : global::System.Data.TypedTableBase<DoctorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DoctorRow AddDoctorRow(long DoctorID, string DoctorFName, string DoctorMName, string DoctorLName, int DoctorStatus, int DoctorType, int DoctorDepartment, int DoctorClinic, string DoctorEmail, string DoctorNotes) {
...
namespace Final2021.DataSet.DataSetSelectDoctorTableAdapters {
    ...
    public partial class DoctorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""main"".""Doctor"" WHERE ((""DoctorID"" = :Original_DoctorID) AND (""DoctorFName"" = :Original_DoctorFName) AND ((:IsNull_DoctorMName = 1 AND ""DoctorMName"" IS NULL) OR (""DoctorMName"" = :Original_DoctorMName)) AND (""DoctorLName"" = :Original_DoctorLName) AND (""DoctorStatus"" = :Original_DoctorStatus) AND (""DoctorType"" = :Original_DoctorType) AND (""DoctorDepartment"" = :Original_DoctorDepartment) AND (""DoctorClinic"" = :Original_DoctorClinic) AND (""DoctorEmail"" = :Original_DoctorEmail) AND ((:IsNull_DoctorNotes = 1 AND ""DoctorNotes"" IS NULL) OR (""DoctorNotes"" = :Original_DoctorNotes)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO ""main"".""Doctor"" (""DoctorID"", ""DoctorFName"", ""DoctorMName"", ""DoctorLName"", ""DoctorStatus"", ""DoctorType"", ""DoctorDepartment"", ""DoctorClinic"", ""DoctorEmail"", ""DoctorNotes"") VALUES (:DoctorID, :DoctorFName, :DoctorMName, :DoctorLName, :DoctorStatus, :DoctorType, :DoctorDepartment, :DoctorClinic, :DoctorEmail, :DoctorNotes)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""main"".""Doctor"" SET ""DoctorID"" = :DoctorID, ""DoctorFName"" = :DoctorFName, ""DoctorMName"" = :DoctorMName, ""DoctorLName"" = :DoctorLName, ""DoctorStatus"" = :DoctorStatus, ""DoctorType"" = :DoctorType, ""DoctorDepartment"" = :DoctorDepartment, ""DoctorClinic"" = :DoctorClinic, ""DoctorEmail"" = :DoctorEmail, ""DoctorNotes"" = :DoctorNotes WHERE ((""DoctorID"" = :Original_DoctorID) AND (""DoctorFName"" = :Original_DoctorFName) AND ((:IsNull_DoctorMName = 1 AND ""DoctorMName"" IS NULL) OR (""DoctorMName"" = :Original_DoctorMName)) AND (""DoctorLName"" = :Original_DoctorLName) AND (""DoctorStatus"" = :Original_DoctorStatus) AND (""DoctorType"" = :Original_DoctorType) AND (""DoctorDepartment"" = :Original_DoctorDepartment) AND (""DoctorClinic"" = :Original_DoctorClinic) AND (""DoctorEmail"" = :Original_DoctorEmail) AND ((:IsNull_DoctorNotes = 1 AND ""DoctorNotes"" IS NULL) OR (""DoctorNotes"" = :Original_DoctorNotes)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DoctorID, DoctorFName, DoctorMName, DoctorLName, DoctorStatus, DoctorType," +
                " DoctorDepartment, DoctorClinic, DoctorEmail, DoctorNotes FROM \"main\".Doctor";
        ...
        public virtual int Fill(DataSetSelectDoctor.DoctorDataTable dataTable) {
        ...
        public virtual DataSetSelectDoctor.DoctorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetSelectDoctor.DoctorDataTable dataTable = new DataSetSelectDoctor.DoctorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetSelectDoctor.DoctorDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetSelectDoctor dataSet) {
        ...
        public virtual int Delete(long Original_DoctorID, string Original_DoctorFName, string Original_DoctorMName, string Original_DoctorLName, int Original_DoctorStatus, int Original_DoctorType, int Original_DoctorDepartment, int Original_DoctorClinic, string Original_DoctorEmail, string Original_DoctorNotes) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_DoctorStatus));
            this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_DoctorType));
            this.Adapter.DeleteCommand.Parameters[7].Value = ((int)(Original_DoctorDepartment));
            this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_DoctorClinic));
            if ((Original_DoctorEmail == null)) {
                throw new global::System.ArgumentNullException("Original_DoctorEmail");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[9].Value = ((string)(Original_DoctorEmail));
            }
            if ((Original_DoctorNotes == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[11].Value = ((string)(Original_DoctorNotes));
            }
        ...
        public virtual int Insert(long DoctorID, string DoctorFName, string DoctorMName, string DoctorLName, int DoctorStatus, int DoctorType, int DoctorDepartment, int DoctorClinic, string DoctorEmail, string DoctorNotes) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(DoctorStatus));
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(DoctorType));
            this.Adapter.InsertCommand.Parameters[6].Value = ((int)(DoctorDepartment));
            this.Adapter.InsertCommand.Parameters[7].Value = ((int)(DoctorClinic));
            if ((DoctorEmail == null)) {
                throw new global::System.ArgumentNullException("DoctorEmail");
            }
            else {
                this.Adapter.InsertCommand.Parameters[8].Value = ((string)(DoctorEmail));
            }
            if ((DoctorNotes == null)) {
                this.Adapter.InsertCommand.Parameters[9].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(DoctorNotes));
            }
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(DoctorStatus));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(DoctorType));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(DoctorDepartment));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(DoctorClinic));
            if ((DoctorEmail == null)) {
                throw new global::System.ArgumentNullException("DoctorEmail");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(DoctorEmail));
            }
            if ((DoctorNotes == null)) {
                this.Adapter.UpdateCommand.Parameters[9].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(DoctorNotes));
            }
            this.Adapter.UpdateCommand.Parameters[10].Value = ((long)(Original_DoctorID));
            if ((Original_DoctorFName == null)) {
                throw new global::System.ArgumentNullException("Original_DoctorFName");
            }
            else {
            ...
            if ((Original_DoctorMName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_DoctorMName));
            }
            if ((Original_DoctorLName == null)) {
                throw new global::System.ArgumentNullException("Original_DoctorLName");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_DoctorLName));
            }
            this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(Original_DoctorStatus));
            this.Adapter.UpdateCommand.Parameters[16].Value = ((int)(Original_DoctorType));
            this.Adapter.UpdateCommand.Parameters[17].Value = ((int)(Original_DoctorDepartment));
            this.Adapter.UpdateCommand.Parameters[18].Value = ((int)(Original_DoctorClinic));
            if ((Original_DoctorEmail == null)) {
                throw new global::System.ArgumentNullException("Original_DoctorEmail");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_DoctorEmail));
            }
            if ((Original_DoctorNotes == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_DoctorNotes));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_DoctorEmail, 
                    string Original_DoctorNotes) {
            return this.Update(Original_DoctorID, DoctorFName, DoctorMName, DoctorLName, DoctorStatus, DoctorType, DoctorDepartment, DoctorClinic, DoctorEmail, DoctorNotes, Original_DoctorID, Original_DoctorFName, Original_DoctorMName, Original_DoctorLName, Original_DoctorStatus, Original_DoctorType, Original_DoctorDepartment, Original_DoctorClinic, Original_DoctorEmail, Original_DoctorNotes);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(DataSetSelectDoctor dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._doctorTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(DataSetSelectDoctor dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._doctorTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(DataSetSelectDoctor dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._doctorTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(DataSetSelectDoctor dataSet) {
            if ((dataSet == null)) {
